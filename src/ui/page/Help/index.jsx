    ...
    return (
        <>
            <div className="f1">
                ...
                <a className="g_row df jcsb aic g_hr pt8 pb8 c:s c:primary:h fs14 fw500 pl8 pr8 fw700 lh24" href="https://www.npmjs.com/package/sacss" target="_blank">
                    <strong>NPM 👉</strong>
                    <span>
                    <img className="db" src="https://img.shields.io/npm/v/sacss.svg" width="80" height="20" alt="sacss"/>
                </span>
                </a>
            </div>
