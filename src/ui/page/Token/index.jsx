  ...
  return (
    <div className="pt12 pb12 g_row mb8 bc:fff">
      ...
      <div className="df aic jcsb mb8">
        <div className="c_s ttc mr8">token {type}:</div>
      ...
      {type === 'Component' ? (
        <>
          ...
          <label className="df aic jcsb mt8">
            <strong className="c_s ttc mr8">stopRenderChildren:</strong>
    ...
    <form className="f1 df fs14 fdc" onSubmit={onSubmit}>
      <div className="f1">
        {(() => {
          ...
          return (<div
            className="h100% df aic jcc tac c_s">
            {noSelection ? 'Please Select Something' : 'The Node without any token'}
          </div>);
        })()}
      </div>
      <div className="g_row pt12 pb12 bc:fff">
